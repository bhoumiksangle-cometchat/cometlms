...
import { Quiz, Question, Option, QuizAttempt } from './quiz.model';
import { AppError } from '../../middleware/errorHandler';

export class QuizService {
  public async getBySection(sectionId: string) {
  ...
  public async submit(quizId: string, userId: string, answers: Record<string, string | string[]>) {
    const quiz = await prisma.quiz.findUnique({
      where: { id: quizId },
      include: {
        questions: {
  ...
  public async getAttempts(quizId: string, userId: string) {
  ...
  public async getLatestAttempt(quizId: string, userId: string) {
